        ...
        <gradlead-home-screen inline-template>
            <div v-if="userLoaded">
                ...
                <div class="app-header navbar">
                    ...
                    <div class="collapse pos-rlt navbar-collapse box-shadow bg-white-only">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                           ...
                           <gradlead-inbox-dropdown :user="authUser"></gradlead-inbox-dropdown>
                ...
                <div class="app-footer wrapper b-t bg-light">
                    <span class="pull-right">1.0.0 <a href="#app" class="m-l-sm text-muted"><i class="fa fa-long-arrow-up"></i></a></span> &copy; 2017 Gradlead 2017
                </div>
                <!-- / footer -->
