...
<div class="hbox hbox-auto-xs hbox-auto-sm" v-if="everythingLoaded">
  ...
  <div class="col">
    ...
    <div class="col wrapper-md">
      <div class="clearfix m-b">
            <button class="btn btn-info btn-addon" @click.prevent="addPartnerOrganization('employer')">
                ...
                <tbody>
                    <tr v-for="o in employers">
                        ...
                        <td class="spark-table-pad">
                            <button class="btn btn-default btn-addon btn-sm btn-circle" @click.prevent="viewPEProfile(o)">
  ...
  <!-- / main -->
        @include('dashboards.organizations.pemployers-add') 
        @include('dashboards.organizations.pemployers-profile-view')
</div>
