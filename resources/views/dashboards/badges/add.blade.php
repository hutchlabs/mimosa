    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <!-- Add Form -->
                <form v-on:submit="addNewBadge($event)" class="form-horizontal" action="/mimosa/api/badges" method="post" enctype="multipart/form-data" id="myform">
                   ...
                   <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input type="file" name="image" id="filer_input" data-jfiler-showThumbs="true" class="form-control">
                                    <p class="help-block">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="submit" value="Add" class="btn btn-primary btn-addon">
                    </div>
                </form>
            </div>
        </div>
