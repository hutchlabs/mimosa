...
class OrganizationsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('organizations')->insert( [ 'subdomain' => 'localhost', 'name' => 'Overcore Tech', 'modified_by' => 1,   'type' => 'employer' ]);
        DB::table('organizations')->insert( [ 'subdomain' => 'localhost', 'name' => 'Hutchlabs', 'modified_by' => 1,   'type' => 'employer' ]);
